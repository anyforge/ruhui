"""Ruhui BERT 后端（原 ruhui，Laya 架构：encoder + 决策头）。

保持原 ruhui 全部用法不变，只是从 ruhui.bert 导入。
"""
...
__all__ = [
    ...
    "proper_reward", "td_lambda_targets", "ece_score", "confidence_from_probs",
    "render_options", "QTYPES", "QTYPE_NAMES",
]
