...
from ruhui.common import render_criterion, render_options  # noqa: E402
...
# has CUDA. `ruhui.load(path, device="cpu")` on a GPU box is a deliberate choice, not a problem.
import inspect  # noqa: E402

from ruhui import agent as _agent  # noqa: E402
